...
const typed = new Typed('.multiple-text', {
     strings: ['Create', 'Read', 'Update', 'Delete', 'Management System', ],
     typeSpeed: 100,
     backSpeed: 100,
     backDelay: 1000,
     loop: true
     ...
     readMoreBtns.forEach(btn => {
          btn.addEventListener('click', function (event) {
             event.preventDefault(); // Prevent default behavior (e.g., page scroll)
               ...
               this.style.pointerEvents = 'none'; // Prevent further clicks
               
               // Toggle the "expanded" class on the parent services box
               const parentBox = this.closest('.services-box');
